...
var getSizeStyles = function (_a) {
    ...
    switch (size) {
        ...
        default: {
            return Ae(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n        font-size: 14px;\n        padding: 11px 20px;\n      "], ["\n        font-size: 14px;\n        padding: 11px 20px;\n      "])));
        }
    }
};
var StyledButton = styled.button(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  font-family: 'Nunito Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;\n  font-weight: 700;\n  border: 0;\n  border-radius: 1em;\n  cursor: pointer;\n  display: inline-block;\n  line-height: 1;\n\n  ", "\n  ", "\n  ", "\n"], ["\n  font-family: 'Nunito Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;\n  font-weight: 700;\n  border: 0;\n  border-radius: 1em;\n  cursor: pointer;\n  display: inline-block;\n  line-height: 1;\n\n  ", "\n  ", "\n  ", "\n"])), function (props) { return getVariantStyles(props); }, function (props) { return getSizeStyles(props); }, function (_a) {
    var backgroundColor = _a.backgroundColor;
    return backgroundColor && Ae(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      background-color: ", ";\n    "], ["\n      background-color: ", ";\n    "])), backgroundColor);
});
var Button = function (_a) {
    var variant = _a.variant, backgroundColor = _a.backgroundColor, size = _a.size, label = _a.label, props = __rest(_a, ["variant", "backgroundColor", "size", "label"]);
    return (r.createElement(StyledButton, __assign({ type: 'button', variant: variant, backgroundColor: backgroundColor, size: size, label: label }, props), label));
};
Button.defaultProps = {
    backgroundColor: '#000',
    variant: 'primary',
